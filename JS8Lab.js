...
let newgreeting = new MyGreeting('Tony', 'Las Vegas')
newgreeting.hello()

let myGreeting = new MyGreeting("JWoww", "LA");
...
let yourBook = new Book("WaterBoy", "Adam Sandler");
...
class Fruit {
  ...
  description() {
    console.log(`A ${this.name} has a ${this.color} and ${this.taste} taste delicious`);
  }
}
